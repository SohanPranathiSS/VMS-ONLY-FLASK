      ...
      <section className="privacy-content">
        <div className="privacy-container-inner">
          ...
          <div className="privacy-section">
            ...
            <p>To exercise these rights, please contact us at <a href="mailto:privacy@visitormanagement.com">privacy@visitormanagement.com</a></p>
          </div>
          ...
          <div className="privacy-section">
            ...
            <div className="contact-info">
              <p><strong>Email:</strong> <a href="mailto:privacy@visitormanagement.com">privacy@visitormanagement.com</a></p>
              <p><strong>Phone:</strong> +1 (800) 123-4567</p>
              <p><strong>Address:</strong> 123 Main St, Tech City, USA 12345</p>
            </div>
          </div>
