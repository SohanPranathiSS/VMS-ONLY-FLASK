...
const VisitorCheckInPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Handle duplicate check-in error specifically
        ...
        <div className="visitor-checkin-container">
            <div className="visitor-checkin-content">
                ...
                <form className="visitor-checkin-form" onSubmit={handleSubmit}>
                    ...
                    {error && (
                        <div className={`visitor-checkin-error ${isDuplicateError ? 'duplicate-checkin' : ''}`}>
                            {error}
                        </div>
                    )}
                    ...
                    <div className="form-buttons">
                        ...
                        <button type="button" className="cancel-button" onClick={() => navigate('/host')}>
                            ❌ Cancel
                        </button>
                    </div>
                </form>
